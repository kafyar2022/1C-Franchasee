...
Simditor.i18n = {
  ...
  'ru-RU': {
    ...
    'uploadFailed': 'Загрузка провалена',
    'uploadError': 'Возникла ошибка при загрузке файла',
    'imageUrl': 'Ссылка',
    'imageSize': 'Размер',
    'imageAlt': 'Подсказка',
    ...
    'fontScaleXLarge': 'Очень большой',
    'fontScaleLarge': 'Большой',
    'fontScaleNormal': 'Нормальный',
    'fontScaleSmall': 'Маленький',
    'fontScaleXSmall': 'Очень маленький'
  }
};
